    ...
    public partial class InitialCreateIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProyectosIgnisClientes_ProyectoIgnis_ProyectoIgnisID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EspecialidadesTecnicos", x => x.ID);
                    table.ForeignKey(
                        name: "FK_EspecialidadesTecnicos_Especialidad_EspecialidadID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TecnicosSugeridosPuestos", x => x.ID);
                    table.ForeignKey(
                        name: "FK_TecnicosSugeridosPuestos_Puesto_PuestoID",
                        column: x => x.PuestoID,
                        principalTable: "Puesto",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TecnicosSugeridosPuestos_Tecnico_TecnicoID",
                        column: x => x.TecnicoID,
                        principalTable: "Tecnico",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EspecialidadesTecnicos_EspecialidadID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TecnicosSugeridosPuestos_PuestoID",
                table: "TecnicosSugeridosPuestos",
                column: "PuestoID");

            migrationBuilder.CreateIndex(
                name: "IX_TecnicosSugeridosPuestos_TecnicoID",
                table: "TecnicosSugeridosPuestos",
                column: "TecnicoID");
        }
